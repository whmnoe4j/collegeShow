...
def collegescoreline(request):
    pass
    #return render(request, "collegescoreline.html")
    '''
    try:
        #从get中提取参数
...
def reportedCollege(request):
    if request.method == 'POST':
        try:
            ...
            print '------------get'
            print tempUser
            #recoSchool = recommendSchoolName(tempUser['stuProvince'], tempUser['stuType'], '2015', tempUser['score'], 1)
            #保存临时的用户成绩分数
...
def recommendSchoolName(stuProvince, stuType, Year, score, page):
    """推荐学校
    http://127.0.0.1:8000/api_recommendSchool/?stuProvince=江西&stuType=文科&year=2015&score=468&page=1
    ...
    Response:{"PageNum": 11, , "Result": "True", "Msg": "Success", "Page": 1,
        ...
        "Batch": {"Province": "江西", "Bacth": "本科三批", "StuType": "文科", "BatchLine": 450, "Year": "2015"}}
    """
